    ...
    <div className="ios-page">
      <div className="ios-safe-content">
        ...
        <div className="ios-nav-bar">
          ...
          <div className="ios-nav-title">Assessment</div>
          <div className="w-16"></div> {/* Spacer */}
        </div>

        {/* Progress Section */}
        <div className="ios-section ios-content-inset">
          <div className="text-center ios-spacing-t-sm">
            <span className="ios-footnote" style={{color: 'var(--ios-label-secondary)'}}>
              {step} of {totalSteps}
            </span>
          </div>
          <div className="ios-spacing-t-sm">
  ...
  return (
    <div>
      <div className="text-center ios-section">
        <h3 className="ios-title-2" style={{color: 'var(--ios-label)'}}>What's your goal?</h3>
      ...
      <div className="ios-list">
        {GOALS.map((goal) => (
          <button
            ...
            className={`ios-list-item no-select transition-all ${
              selected === goal.id
          ...
          >
            <div className="flex items-center space-x-4 w-full">
              ...
              <span className="ios-body font-medium" style={{color: selected === goal.id ? 'white' : 'var(--ios-label)'}}>
                {goal.label}
              </span>
            </div>
          </button>
